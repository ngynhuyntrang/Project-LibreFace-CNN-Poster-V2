...
parser.add_argument('--data', type=str, default='../../data/raf_db')
...
def main():
    ...
    # set_seeds already sets cudnn.deterministic=True and benchmark=False
...
class RecorderMeter1(object):
    ...
    def plot_confusion_matrix(self, cm, title='Confusion Matrix', cmap=plt.cm.binary):
        ...
        fig, ax = plt.subplots()
        im = ax.imshow(cm_normalized, interpolation='nearest', cmap=plt.cm.binary)
